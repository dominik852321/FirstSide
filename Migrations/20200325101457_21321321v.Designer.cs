...
namespace FirstSide.Migrations
{
    ...
    [Migration("20200325101457_21321321v")]
    partial class _21321321v
    {
            ...
            modelBuilder.Entity("FirstSide.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f7ae9715-8e95-44f5-8275-56cd569db303",
                            Email = "domin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "DOMIN@GMAIL.COM",
                            NormalizedUserName = "DOMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEJddhiviEOoKJhcfwTyZynMv61+ct75rUJKdxiB3kbDmAeAma+p/Bhfvk/JDIqsKog==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1d2277e6-417b-43d1-b94b-e648055c3405",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b094f138-3b9a-4640-aee3-d35951378bbd",
                            Name = "Admin",
            ...
            modelBuilder.Entity("FirstSide.Models.Comment", b =>
                {
                    ...
                    b.HasOne("FirstSide.Models.Restaurant", null)
                        .WithOne("Comment")
                        .HasForeignKey("FirstSide.Models.Comment", "RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
