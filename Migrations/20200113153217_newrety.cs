...
{
    public partial class newrety : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PizzaPromotions = table.Column<int>(nullable: false),
                    AlcoholPromotions = table.Column<int>(nullable: false),
                    DrinkPromotions = table.Column<int>(nullable: false),
                    FoodsPromotions = table.Column<int>(nullable: false),
                    TablePromotions = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Promotions = table.Column<int>(nullable: false),
